                        ...
                        {isCorrect ? (
                            <>
                                <Typography variant="h6" gutterBottom>
                                    <b>Correct reply</b> 👍. Thanks for your input, it will help us better understand the experimental results. An extra $
                                    {Math.abs(earnedAmount).toFixed(2)} will be added to your final score ⭐.
                                </Typography>
                                <Typography variant="body1" gutterBottom>
